...
class Patient(Base):
    ...
    idPatient = Column(Integer, primary_key=True, unique = True)
    ...
    health_details_id = Column(Integer, ForeignKey('Health_Details.health_details_id'),unique=True)
    guardian_id = Column(Integer, ForeignKey('Guardian_Details.guardian_id'),unique=True)
