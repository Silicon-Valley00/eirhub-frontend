...
export function GuardianForm(props) {
    ...
    function handleEmailChange() {
        if (guardianEmail.current.value && guardianEmail.current.value.trim().match(emailPattern)) {
            setEmailError(null);
    ...
    function handleIdNumberChange() {
        ...
        } else if (guardianIdNumber.current.value && (guardianIdNumber.current.value.trim().match(idNumberPattern))) {
            setIdNumberError(null);
        } else {
    ...
    return (
        <div className={!props.needGuardian ? `${styles.rightRegion} ${styles.hideForm}`: `${styles.rightRegion}`} >
